...
def index():
    if request.method == 'POST':
        ...
        # Validação: a data de início não pode ser maior que a data atual
        if start_date > today:
            return render_template('index.html', message="Erro: A data de início não pode ser maior que a data atual.")
        ...
        return render_template('index.html', end_date=end_date_formatted, remaining_months=remaining_months, total_fine=total_fine, num_lines=num_lines)
